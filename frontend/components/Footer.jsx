    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Washing Machines", path: '/', icon: null },
                { text: "Headphones", path: '/', icon: null },
                { text: "Fridges", path: '/', icon: null },
                { text: "Microwaves", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91 62********", path: '/', icon: PhoneIcon },
                { text: "shresthsamyak@gmail.com", path: '/', icon: MailIcon },
                { text: "Patiala, Punjab, India", path: '/', icon: MapPinIcon }
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-3 text-sm">Welcome to Echo, your destination for smarter shopping. From cutting-edge appliances to everyday essentials, Echo pairs every product with an intelligent assistant to help you choose, use, and troubleshoot with confidence.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    © 2026 Echo — Every product has opinions. We just taught them to talk.
                </p>
            </div>
        </footer>
    );
